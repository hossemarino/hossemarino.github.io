...
})({"8h2Uk":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "a6d58f54d7d05989";
"use strict";
...
},{}],"hSpoG":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "createTab", ()=>createTab);
...
parcelHelpers.export(exports, "saveAllTabs", ()=>saveAllTabs);
...
let editorArea;
function createEditorView(doc = "", theme = (0, _themeOneDark.oneDark), wrap = true) {
    return new (0, _view.EditorView)({
        parent: editorArea,
        state: (0, _state.EditorState).create({
            ...
            extensions: [
                ...
                (0, _langXml.xml)(),
                (0, _autocomplete.bracketMatching)(),
                closeBrackets(),
                wrap ? (0, _view.EditorView).lineWrapping : [],
                theme,
                (0, _view.keymap).of([
                    {
                        key: "Tab",
                    ...
                    {
                        key: "Ctrl-b",
                        run: ()=>_functionsJs.wrapSelection(tabs[activeTab].editor, "b")
                    },
                    {
                        key: "Ctrl-i",
                        run: ()=>_functionsJs.wrapSelection(tabs[activeTab].editor, "i")
                    },
                    {
                        key: "Ctrl-u",
...
function closeTab(name) {
    ...
    if (activeTab === name) switchTab("default");
    renderTabs();
    saveAllTabs();
}
...
function saveAllTabs() {
    const saved = {};
    for (const [name, { editor }] of Object.entries(tabs))saved[name] = {
...
},{"@codemirror/view":"c2noD","@codemirror/state":"axaOu","codemirror":"ak95T","@codemirror/lang-xml":"kSget","@codemirror/theme-one-dark":"6OGAW","@codemirror/language":"dx7XI","@codemirror/autocomplete":false,"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./functions.js":"3Zc1l"}]},["8h2Uk","hSpoG"], "hSpoG", "parcelRequire8bb2", {})

//# sourceMappingURL=survey3.d7d05989.js.map
